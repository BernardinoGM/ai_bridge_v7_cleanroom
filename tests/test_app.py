...
def test_terminal_low_information_inputs_steer_into_coding_intake() -> None:
    ...
    cases = {
        ...
        "what can you do": "Yes. Tell me what you need built, fixed, reviewed, or explained.",
        "can you code": "Yes. Tell me what you need built, fixed, reviewed, or explained.",
        "could you code": "Yes. Tell me what you need built, fixed, reviewed, or explained.",
        "code": "Tell me what you need built, fixed, reviewed, or explained. Include the file, diff, language, or current error.",
        "code for me": "Tell me what you need built, fixed, reviewed, or explained. Include the file, diff, language, or current error.",
        "build": "Tell me what you need built, fixed, reviewed, or explained. Include the file, diff, language, or current error.",
        "build something": "Tell me what you need built, fixed, reviewed, or explained. Include the file, diff, language, or current error.",
